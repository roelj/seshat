        ...
        for group in groups:
            ...
            for member in group:
                ...
                if account is not None:
                    ...
                    common_name = " ".join ([part for part in (first_name, last_name) if part])
                    if not common_name:
...
def read_configuration_file (server, config_file, logger, config_files, parents=()):
    ...
    try:
        ...
        config.disable_account_creation = read_boolean_value (xml_root, "disable-account-creation",
                                                              config.disable_account_creation, logger)
